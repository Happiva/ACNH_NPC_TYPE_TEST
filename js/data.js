...
const dataList = [
    ...
    {
        q: '친구의 연인이 바람을 피워서 친구가 차였다. 친구를 위로할 때',
        a: [
            {
                answer: '같이 씩씩대며 분노해준다.',
                type: [4 , 7 , 0 , 6 , 2 , 1 , 5 , 3],
            },
            {
                answer: '조용히 토닥이며 술을 사준다.',
                type: [10 , 12 , 13 , 9 , 11 , 14. , 15 , 8],
            },
    ...
    {
        q: '모동숲 게임이 드디어 온다! 게임이 오기 전 내가 하는 일은?',
        a: [
            {
                answer: '인기주민을 얻기 위한 공략을 찾아본다.',
                type: [10 , 9 , 8 , 11],
            },
            {
    ...
    },
    {
        ...
        a: [
            {
                answer: '뮤비의 배경 및 세계관 해석까지 다 찾아본다.',
                type: [10 , 9 , 8 , 11],
            },
            {
                answer: '이번 뮤비 헤메코 다 대박이다 ㅠㅠ 넋놓고 최애를 감상한다.',
                type: [13,12,14,15],
            },
    ...
    },
    {
        ...
        a: [
            {
                answer: '내가 어제 줄서서 산 한정판... 일단 울컥한다.',
                type: [4 , 5],
            },
            {
                answer: '그거 한정판..10만원...친절히 가격을 안내하여 보상을 유도한다.',
                type: [7 , 6],
            },
    ...
    {
        q: '내일 오후 수업이 휴강해서 오전 교양 하나밖에 없다!!',
        a: [
            {
    ...
    },
    {
        ...
        a: [
            ...
            {
                answer: '말없이 음료를 많이 넣어드린다.',
                type: [9],
            },            
        ],
    },
    {
        q: '코앞으로 다가온 레포트 마감, 마감을 맞추려면 오늘 밤을 새야한다...',
        a: [
            {
            ...
            {
                answer: '과제 하나쯤은 괜찮아... 어차피 못할 것 같으니 편하게 잔다.',
                type: [11],
            },            
        ],
    },
